...
public final class DropDown: UIView {
    ...
    fileprivate let tableView = SelfResizingTableView()
    ...
    */
    ...
    public var tableMaxHeight: CGFloat = 208 {
        didSet { reloadAllComponents() }
    }
    
    public var showsVerticalScrollIndicator: Bool {
        get { tableView.showsVerticalScrollIndicator }
    ...
    */
    ...
    fileprivate var tableHeight: CGFloat {
        if dataSource.count > 4 {
            return min(tableMaxHeight, tableView.contentSize.height)
        }
